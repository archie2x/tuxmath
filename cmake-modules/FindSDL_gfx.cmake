...
if(${SDLGFX_INCLUDE_DIR} MATCHES ".framework")
    ...
    string(
        ...
        "\\1"
        SDLGFX_FRAMEWORK_PATH_TEMP
        ${SDLGFX_INCLUDE_DIR}
    )
    if(
        "${SDLGFX_FRAMEWORK_PATH_TEMP}" STREQUAL "/Library/Frameworks"
        ...
        set(SDLGFX_LIBRARY
            "-F${SDLGFX_FRAMEWORK_PATH_TEMP} -framework SDL_gfx"
            CACHE STRING
            "SDL_gfx framework for OSX"
        )
    endif(
