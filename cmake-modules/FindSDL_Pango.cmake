...
if(${SDLPANGO_INCLUDE_DIR} MATCHES ".framework")
    ...
    string(
        REGEX REPLACE "(.*)/.*\\.framework/.*"
        "\\1"
        SDLPANGO_FRAMEWORK_PATH_TEMP
        ${SDLPANGO_INCLUDE_DIR}
    )
    if(
        "${SDLPANGO_FRAMEWORK_PATH_TEMP}" STREQUAL "/Library/Frameworks"
        ...
        set(SDLPANGO_LIBRARY
            "-F${SDLPANGO_FRAMEWORK_PATH_TEMP} -framework SDL_Pango"
            CACHE STRING
            "SDL_Pango framework for OSX"
        )
    endif(
