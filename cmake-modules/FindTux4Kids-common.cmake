...
if(${T4KCOMMON_INCLUDE_DIR} MATCHES ".framework")
    ...
    string(
        ...
        "\\1"
        T4KCOMMON_FRAMEWORK_PATH_TEMP
        ${T4KCOMMON_INCLUDE_DIR}
    )
    if(
        "${T4KCOMMON_FRAMEWORK_PATH_TEMP}" STREQUAL "/Library/Frameworks"
        OR "${T4KCOMMON_FRAMEWORK_PATH_TEMP}" STREQUAL "/System/Library/Frameworks"
    )
        # String is in default search path, don't need to use -F
        set(T4KCOMMON_LIBRARY
            "-framework Tux4Kids-common"
            CACHE STRING
        ...
        set(T4KCOMMON_LIBRARY
            "-F${T4KCOMMON_FRAMEWORK_PATH_TEMP} -framework
    Tux4Kids-common"
            CACHE STRING
            "Tux4Kids-common framework for OSX"
        )
